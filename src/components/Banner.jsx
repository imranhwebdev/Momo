        ...
        <div className="banner">
            <figure className='banner__shap'>
                <svg xmlns="http://www.w3.org/2000/svg" width="1111" height="1189" viewBox="0 0 1111 1189" fill="none">
                    ...
                    <defs>
                        ...
                        <stop stop-color="#B45DA2"/>
                        <stop offset="0.46875" stop-color="#BB209B"/>
                        <stop offset="0.734375" stop-color="#CF6FBB"/>
                        <stop offset="1" stop-color="#FF90E8"/>
                        </radialGradient>
                    </defs>
                </svg>
            </figure>
            ...
            <Container>
                <Row className='align-items-center'>
                    ...
                    <Col lg={6}>
                        <figure className='text-center text-lg-end px-5 px-md-0'>
